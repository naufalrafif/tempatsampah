        ...
        <div class="slider-area">
            <div class="bend niceties preview-2">
                <div id="ensign-nivoslider" class="slides">
                    ...
                    <img src="/annprint/slider-2.png" alt="" title="#slider-direction-2" />
                </div>
                <!-- direction 1 -->
                        ...
                        <div class="title-container s-tb-c title-compress">
                            <div class="layer-1">
                                ...
                                <div class="wow fadeIn" data-wow-duration="2s" data-wow-delay="2.5s">
                                    <h3 class="slider-title2 text-uppercase" style="color:white"> Wanaraya dusbin
                                    </h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="title-container s-tb-c title-compress">
                            <div class="layer-1">
                                <div class="wow fadeInUpBig" data-wow-duration="1.5s" data-wow-delay="0.5s">
                                    <h2 class="slider-title1 text-uppercase">Wanaraya dusbin</h2>
                                </div>
                                <div class="wow fadeInUpBig" data-wow-duration="2s" data-wow-delay="0.5s">
                                    <p class="slider-pro-brief">
                                        UMKM yang berjalan di bidang pembuatan tempat sampah berada dibekasi jawa barat
                                    </p>
                                </div>
                            </div>
                        </div>
